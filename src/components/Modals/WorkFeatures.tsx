...
const featureContent: Record<string, WorkFeatureContent> = {
  process: {
    ...
    personalImportance: "As someone who has spent years in Leadership, I've learned that the most meaningful solutions come from genuine connections. When I sit down for a 1-1 consultation, I'm not just gathering requirements - I'm listening to your story, understanding your passions, and committing myself to helping you achieve your goals. This process reflects my belief that technology should serve human connections, not replace them."
  },
  commitment: {
    title: "Our Commitment: Excellence Through Dedication",
    description: "Excellence isn't just a goal - it's a commitment we make to every client, every project, and every line of code we write. It's about creating solutions that tell your story and inspire others.",
    ...
    companyImportance: "Excellence is woven into every aspect of our work. From our rigorous development practices to our client communication, we maintain the highest standards because we believe that's what our clients expect when they provide your income. This commitment drives us to continuously learn, adapt, and improve, ensuring we're always delivering the best possible solutions.",
    personalImportance: "Throughout my career, I've lived by a simple principle: Trust and consistency do not live in isolation. This isn't just about writing code or building systems - it's about making a real difference in people's lives. When I commit to a project, I'm committing my full expertise, creativity, and dedication to ensuring its success. This level of personal investment in every project comes from my belief that true excellence is achieved when we pour our hearts into our world."
  },
  expectations: {
    title: "Your Expectations: Our Blueprint for Success",
    description: "We believe in setting clear expectations and then consistently exceeding them. Your trust is earned through our reliability, transparency, consistency, and unwavering dedication to your success.",
    clientImportance: "We understand that entrusting your project to a us as your partner is a significant decision. That's why we've built our entire service model around ensuring you always feel informed, supported, and confident in our partnership. From clear timelines and regular updates to transparent pricing and responsive support, every aspect of our service is designed to give you peace of mind and confidence in your investment.",
