        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <motion.div
                whileHover={{ y: -5 }}
                className="relative rounded-xl p-6 bg-white dark:bg-gray-800"
                style={{
              ...
              <AccordionItem value="gradient" className="border-none">
                ...
                <AccordionContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
                    <motion.div
                      whileHover={{ y: -5, scale: 1.02 }}
                      className="relative overflow-hidden rounded-xl bg-gradient-to-br from-violet-500/20 to-purple-600/20 p-6 border border-violet-500/20"
                    >
                    ...
                    <motion.div
                      whileHover={{ y: -5, scale: 1.02 }}
                      className="relative overflow-hidden rounded-xl bg-gradient-to-br from-emerald-500/20 to-teal-600/20 p-6 border border-emerald-500/20"
                    >
                    ...
                    <motion.div
                      whileHover={{ y: -5, scale: 1.02 }}
                      className="relative overflow-hidden rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-600/20 p-6 border border-amber-500/20"
                    >
